                    ...
                    <div className="footer__lists mt-40">
                      <div className="footer__list-item mb-40">
                        ...
                        <div className="footer__list-text">
                          <p><a href="https://goo.gl/maps/iAY7xEk5PGbqwBWf6" target="blank">Al-Abdali, King Hussien St,
                            11145 Jordan </a></p>
                        </div>
                      </div>
                      <div className="footer__list-item mb-40">
                      ...
                      <div className="footer__list-item mb-40">
                        ...
                        <div className="footer__list-text">
                          <p><a href="tel:+962797427574">+962 79 7427574</a></p>
            ...
            <div className="row align-items-center">
              <div className="col-xl-12">
                <div className="footer-copyright-text">
                  <p>© 2022 Cashmere - Enterprise Solutions . All Rights Reserved.</p>
                </div>
              </div>
            </div>
          </div>
