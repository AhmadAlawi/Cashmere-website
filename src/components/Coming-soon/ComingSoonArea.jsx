                ...
                <div className="coming__countdown mt-80 text-center">
                  <div className="coming__countdown-inner d-flex align-items-center">
                    ...
                    <div className="cdown day"><span className="time-count">
                      {Time('2022-11-21 14:00:00').days}</span> <p>Days</p>
                    </div>
                    <div className="cdown hour">
                      <span className="time-count">{Time('2022-11-21 14:00:00').hours}</span> <p>Hrs</p>
                    </div>
                    <div className="cdown minutes">
                      <span className="time-count">{Time('2022-11-21 14:00:00').minutes}</span> <p>Min</p>
                    </div>
                    <div className="cdown second"> <div>
                      <span className="time-count">{Time('2022-11-21 14:00:00').seconds}</span> <p>Sec</p></div>
                    </div>
